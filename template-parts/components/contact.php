...
<section class="container contactSelection">
    ...
    <div class="row justify-content-center contactRow">
            <section class="col-2">
                <a href="request-service/" class="icon">
                    <h3>Request Service</h3>
                </a>
            </section>
            <section class="col-2">
                <a href="request-parts/" class="icon">
                    <h3>Request Parts</h3>
                </a>
            </section>
            <section class="col-2">
                <a href="value-unit/" class="icon">
                    <h3>Value Unit</h3>
                </a>
            </section>
            <section class="col-2">
...
<!--Commented this out because I'm tired of fighting about forms, just going to use jotform-->
...
<!--                <label for="textYouYes">Yes</label><br>-->
<!--                <input type="radio" id="textYouNo" name="textYou" value="No" checked>-->
<!--                <label for="textYouNo">No</label><br><br>-->
<!---->
