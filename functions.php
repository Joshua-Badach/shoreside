...
function hero_shortcode(){
    $hero = include('template-parts/components/heroVideo.php');
    return $hero;
}
add_shortcode('hero', 'hero_shortcode');

function insta_shortcode(){
    $insta = include('template-parts/components/instagram.php');
    return $insta;
}
...
function quote_shortcode(){
    $quote = include('template-parts/components/quote.php');
    return $quote;
}
